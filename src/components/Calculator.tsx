    ...
    <main className="h-[100svh] w-full bg-bold-bg flex flex-col overflow-hidden">
      <header className="flex items-center justify-between px-5 py-4 shrink-0">
        <button
          ...
          className="p-2 rounded-full hover:bg-bold-num transition-colors text-bold-textPrimary relative"
        >
        ...
        <span className="text-bold-textSecondary text-sm font-medium tracking-wide">КАЛЬКУЛЯТОР</span>
